...
@section('title') WilcoERP - Inspection Items @endsection
        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    @if(SICAPHelper::checkPermission(9, 2)||SICAPHelper::checkPermission(9, 3))
                    <div class="dropdown dropdown-inline">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <ul class="kt-nav">
                                ...
                                @if(SICAPHelper::checkPermission(9, 2))
                                ...
                                @endif
                                @if(SICAPHelper::checkPermission(9, 3))
                                <li class="kt-nav__item">
...
<div class="modal fade" id="modal_add_element" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('interface_insert')}}"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('post')
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control " id="type" required>
                                    ...
                                    <option class="text-capitalize" value="trucks_cars" {{old('type')? ("trucks_cars"==old('type'))? 'selected':'' :''}}>Vehicles</option>
                                    <option class="text-capitalize" value="equipment_trailer" {{old('type')? ("equipment_trailer"==old('type'))? 'selected':'' :''}}>Equipment/trailer</option>
                                </select>
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="">Is critical</label>
                                <div class="kt-radio-inline d-flex justify-content-center p-2">
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="critical" id="critical-true" value="true" {{old('critical')? (old('critical')=='true')? 'checked' :'' : ''   }}> Yes
                                        <span></span>
                                    </label>
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="critical" id="critical-false" value="false" {{old('critical')? (old('critical')=='false')? 'checked' :'' : 'checked'   }}> No
                                        <span></span>
                                    </label>
                                </div>
                            </div>
...
@endif
@if(SICAPHelper::checkPermission(9, 1))
...
<div class="modal fade" id="modal_edit_element" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('interface_update')}}"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
                @csrf
                @method('post')
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="kt-radio-inline d-flex justify-content-center p-2">
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="critical" id="critical-true-edit" value="true"   > Yes
                                        <span></span>
                                    </label>
                                    <label class="kt-radio kt-radio--solid">
                                        <input type="radio" name="critical" id="critical-false-edit" value="false" > No
                                        <span></span>
                                    </label>
                                </div>
                            </div>
...
<div class="modal fade" id="modal_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('interface_delete')}}" id="form_delete" method="POST" autocomplete="off">
                @csrf
                @method('delete')
...
<div class="modal fade" id="modal_delete_element" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('interface_delete')}}"  method="POST" autocomplete="off">
                @csrf
                @method('delete')
...
<script src="{{asset("assets")}}/js/page-interface.js" type="text/javascript"></script>
@endsection